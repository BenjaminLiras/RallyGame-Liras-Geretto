extends Control
## UI del sistema multijugador
## Muestra información de ambos jugadores y sus decisiones
...
func crear_ui() -> void:
	"""Crea la interfaz de usuario para el multijugador"""
	
	# Panel izquierdo para Jugador 1
...
func actualizar_ui() -> void:
	"""Actualiza la información de la UI cada frame"""
...
func obtener_nombre_decision(tipo_decision: int) -> String:
	"""Convierte el tipo de decisión a un nombre legible"""
	match tipo_decision:
		0:  # ATACAR
			return "ATACAR"
		1:  # MODERAR
